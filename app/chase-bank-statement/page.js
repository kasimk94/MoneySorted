...
export const metadata = {
  title: 'Chase Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Chase UK bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Chase login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/chase-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Chase bank statement as PDF?',
    a: 'Open the Chase app, tap Profile in the top right, go to Statements & documents, select the month and download as PDF. Chase UK is app-only — there is no desktop banking portal.',
  },
  {
    q: 'How far back can I get Chase statements?',
    a: 'Chase provides statements from the date you opened your account, all available through the app.',
  },
  {
    q: 'Does MoneySorted work with Chase UK accounts?',
    a: 'Yes, MoneySorted analyses Chase UK current account statements. Note that Chase UK is a personal banking app — business accounts are not currently offered.',
  },
  {
    q: 'Is my Chase data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Chase Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/chase-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .chbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .chbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="chbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <h1 style={{
            ...
            Chase Bank Statement Analyser
          </h1>
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with Chase UK statements. Upload your PDF and get instant spending analysis in seconds.
          </p>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Chase statement',
                desc: 'Open the Chase app, tap Profile in the top right, go to Statements & documents, select the month and download as PDF. Chase UK is app-only with no desktop portal.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Chase PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Chase login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Chase statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Chase PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Chase statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Chase spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Chase statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
        ...
        <p style={{ textAlign: 'center', color: '#4A5568', fontSize: '0.82rem', margin: 0 }}>
          Also see:{' '}
          <Link href="/chase-bank-statement-guide" style={{ color: '#8A9BB5', textDecoration: 'underline', textUnderlineOffset: 3 }}>
            Chase statement guide
          </Link>
          {' · '}
