...
export const metadata = {
  title: 'Halifax Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Halifax bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Halifax login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/halifax-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Halifax bank statement as PDF?',
    a: 'Log into Halifax online banking at halifax.co.uk or the Halifax app, go to your account, select Statements, choose your date range and download as PDF.',
  },
  {
    q: 'How far back can I get Halifax statements?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Halifax Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/halifax-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .hxbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .hxbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="hxbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Halifax statement',
                desc: 'Log in to Halifax online banking or the Halifax app, go to Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Halifax PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Halifax login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Halifax statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Halifax PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Halifax statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Halifax spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Halifax statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
