...
export const metadata = {
  title: 'HSBC Business Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your HSBC Business bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no HSBC login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/hsbc-business-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my HSBC Business bank statement as PDF?',
    a: 'Log into HSBC Business Online Banking at business.hsbc.co.uk, go to your account, select Statements, choose your date range and download as PDF. You can also access statements through the HSBC Business app.',
  },
  {
    q: 'Does MoneySorted work with HSBC Business accounts?',
    a: 'Yes, MoneySorted is fully compatible with HSBC Business account statements, including sole trader, limited company, and HSBC Kinetic accounts.',
  },
  {
  ...
  {
    q: 'Is my HSBC Business data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'HSBC Business Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/hsbc-business-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .hbbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .hbbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="hbbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <h1 style={{
            ...
            HSBC Business Bank Statement Analyser
          </h1>
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with HSBC Business account statements. Upload your PDF and get instant spending analysis in seconds.
          </p>
          ...
          >
            Analyse My HSBC Business Statement →
          </Link>
        </section>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your HSBC Business statement',
                desc: 'Log in to HSBC Business Online Banking or the HSBC Business app, go to Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your HSBC Business PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no HSBC login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your HSBC Business statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your HSBC Business PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common HSBC Business statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your HSBC Business spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your HSBC Business statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
        ...
        <p style={{ textAlign: 'center', color: '#4A5568', fontSize: '0.82rem', margin: 0 }}>
          ...
          {' · '}
          <Link href="/hsbc-bank-statement" style={{ color: '#8A9BB5', textDecoration: 'underline', textUnderlineOffset: 3 }}>
            HSBC personal account analyser
          </Link>
          {' · '}
