...
export const metadata = {
  title: 'Santander Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Santander bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Santander login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/santander-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Santander bank statement as PDF?',
    a: 'Log into Santander online banking at santander.co.uk or the Santander app, go to your account, select Statements, choose your date range and download as PDF.',
  },
  {
    q: 'How far back can I get Santander statements?',
    a: 'Santander provides up to 7 years of statements online for most current accounts.',
  },
  {
    q: 'Does MoneySorted work with Santander Business accounts?',
    a: 'Yes, MoneySorted analyses both Santander personal and business account statements.',
  },
  {
    q: 'Is my Santander data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Santander Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/santander-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .sabsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .sabsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="sabsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with Santander personal and business statements. Upload your PDF and get instant spending analysis in seconds.
          </p>
          ...
          >
            Analyse My Santander Statement →
          </Link>
        </section>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Santander statement',
                desc: 'Log in to Santander online banking or the Santander app, go to Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Santander PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Santander login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Santander statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Santander PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Santander statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Santander spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Santander statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
