...
export const metadata = {
  title: 'Revolut Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Revolut bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Revolut login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/revolut-bank-statement' },
};
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes, MoneySorted analyses both Revolut personal and business account statements.',
  },
  {
    q: 'Is my Revolut data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Revolut Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/revolut-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .rvbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .rvbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="rvbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Revolut statement',
                desc: 'Open the Revolut app, go to your account, tap Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Revolut PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Revolut login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Revolut statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Revolut PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Revolut statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Revolut spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Revolut statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
        ...
        <p style={{ textAlign: 'center', color: '#4A5568', fontSize: '0.82rem', margin: 0 }}>
          Also see:{' '}
          <Link href="/revolut-bank-statement-guide" style={{ color: '#8A9BB5', textDecoration: 'underline', textUnderlineOffset: 3 }}>
            Revolut statement guide
          </Link>
          {' · '}
