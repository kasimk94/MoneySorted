...
export const metadata = {
  title: 'first direct Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your first direct bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no first direct login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/first-direct-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my first direct bank statement as PDF?',
    a: 'Log into first direct online banking at firstdirect.com or the first direct app, go to your account, select Statements, choose your date range and download as PDF.',
  },
  {
    q: 'How far back can I get first direct statements?',
    a: 'first direct provides up to 7 years of statements online for most accounts.',
  },
  {
    q: 'Does MoneySorted work with first direct 1st Account?',
    a: 'Yes, MoneySorted works with all first direct current account statements including the 1st Account.',
  },
  {
    q: 'Is my first direct data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'first direct Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/first-direct-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .fdbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .fdbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="fdbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <h1 style={{
            ...
            first direct Bank Statement Analyser
          </h1>
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with first direct statements. Upload your PDF and get instant spending analysis in seconds.
          </p>
          ...
          >
            Analyse My first direct Statement →
          </Link>
        </section>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your first direct statement',
                desc: 'Log in to first direct online banking or the first direct app, go to Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your first direct PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no first direct login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your first direct statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your first direct PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common first direct statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your first direct spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your first direct statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
        ...
        <p style={{ textAlign: 'center', color: '#4A5568', fontSize: '0.82rem', margin: 0 }}>
          Also see:{' '}
          <Link href="/first-direct-bank-statement-guide" style={{ color: '#8A9BB5', textDecoration: 'underline', textUnderlineOffset: 3 }}>
            first direct statement guide
          </Link>
          {' · '}
