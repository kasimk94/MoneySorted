...
export const metadata = {
  title: 'Monzo Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Monzo bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Monzo login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/monzo-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Monzo bank statement as PDF?',
    a: 'Open the Monzo app, go to Account, tap Statements, select your date range and choose Download PDF.',
  },
  {
    q: 'Does Monzo provide PDF statements?',
    a: 'Yes, Monzo provides downloadable PDF statements through the app for all account types.',
  },
  {
    q: 'Does MoneySorted work with Monzo joint accounts?',
    a: 'Yes, MoneySorted works with both Monzo personal and joint account statements.',
  },
  {
    q: 'Is my Monzo data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Monzo Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/monzo-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .mbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .mbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="mbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with Monzo statements including personal and joint accounts. Upload your PDF and get instant results.
          </p>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Monzo statement',
                desc: 'Open the Monzo app, go to Account, tap Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Monzo PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Monzo login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Monzo statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Monzo PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Monzo statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Monzo spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Monzo statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
