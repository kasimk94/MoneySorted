...
export const metadata = {
  title: 'Nationwide Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Nationwide bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Nationwide login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/nationwide-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Nationwide bank statement as PDF?',
    a: 'Log into Nationwide online banking at nationwide.co.uk or the Nationwide app, go to your account, select Statements, choose your date range and download as PDF.',
  },
  {
    q: 'How far back can I get Nationwide statements?',
    a: 'Nationwide provides up to 7 years of statements online for most current accounts.',
  },
  {
    q: 'Does MoneySorted work with Nationwide FlexAccount?',
    a: 'Yes, MoneySorted works with all Nationwide current account statements including FlexAccount, FlexPlus, and FlexDirect.',
  },
  {
    q: 'Is my Nationwide data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Nationwide Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/nationwide-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .nwbsa2 p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .nwbsa2 strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="nwbsa2" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <h1 style={{
            ...
            Nationwide Bank Statement Analyser
          </h1>
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with Nationwide current account statements. Upload your PDF and get instant spending analysis in seconds.
          </p>
          ...
          >
            Analyse My Nationwide Statement →
          </Link>
        </section>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Nationwide statement',
                desc: 'Log in to Nationwide online banking or the Nationwide app, go to Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Nationwide PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Nationwide login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Nationwide statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Nationwide PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Nationwide statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Nationwide spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Nationwide statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
