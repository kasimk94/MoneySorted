...
export const metadata = {
  title: 'Starling Bank Statement Analyser | Free PDF to Excel UK',
  description: 'Analyse your Starling Bank statement in seconds. Get spending categories, transaction history and Excel export. Free, secure, no Starling login required.',
  alternates: { canonical: 'https://www.getmoneysorted.co.uk/starling-bank-statement' },
};

const FAQ_ITEMS = [
  {
    q: 'How do I download my Starling Bank statement as PDF?',
    a: 'Log into the Starling app, go to your account, tap Statements, choose your date range and download as PDF.',
  },
  {
    q: 'Does MoneySorted work with Starling business accounts?',
    a: 'Yes, MoneySorted analyses both Starling personal and business account statements.',
  },
  {
    q: 'How far back can I get Starling statements?',
    a: 'Starling provides statements from the date you opened your account, all available through the app.',
  },
  {
    q: 'Is my Starling data safe?',
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Starling Bank Statement Analyser', item: 'https://www.getmoneysorted.co.uk/starling-bank-statement' },
      ],
    },
  ],
};
  ...
  return (
    <div style={{ background: '#080C14', minHeight: '100vh', color: '#F5F0E8' }}>
      ...
      <style>{`
        ...
        .sbsa p { color: #8A9BB5; font-size: 1rem; line-height: 1.75; margin: 0 0 1em; }
        .sbsa strong { color: #F5F0E8; }
      `}</style>

      <BlogNavWrapper />

      <main className="sbsa" style={{ maxWidth: 860, margin: '0 auto', padding: '120px 24px 96px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <p style={{ color: '#8A9BB5', fontSize: '1.1rem', lineHeight: 1.75, maxWidth: 640, margin: '0 auto 36px' }}>
            MoneySorted works perfectly with Starling Bank statements for personal and business accounts. Upload your PDF and get instant spending analysis.
          </p>
        ...
        <section style={{ marginBottom: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              {
                num: '01',
                title: 'Download your Starling statement',
                desc: 'Log into the Starling app, go to your account, tap Statements, choose your date range, and download your statement as a PDF. Takes about 30 seconds.',
              },
              {
                num: '02',
                title: 'Upload to MoneySorted',
                desc: 'Drop your Starling PDF into MoneySorted. We parse every transaction automatically — no manual entry, no linking your account, no Starling login needed.',
              },
              {
                num: '03',
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2>What you get from your Starling statement</h2>
            <p style={{ maxWidth: 540, margin: '0 auto' }}>Everything MoneySorted extracts from your Starling PDF — automatically, with no manual work.</p>
          </div>
          <div style={{
        ...
        <section style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2>Common Starling statement questions</h2>
          </div>
        ...
        <section style={{
          ...
          <h2 style={{ marginBottom: 12 }}>Ready to understand your Starling spending?</h2>
          <p style={{ maxWidth: 480, margin: '0 auto 32px' }}>
            Upload your Starling statement now and get a full breakdown in seconds. Free, private, no account required to try.
          </p>
          <Link
            href="/upload"
            style={{
